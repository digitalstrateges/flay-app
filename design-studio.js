...
<body>
    ...
    getThemeColors(theme) {
        const themes = {
            ...
            light: { bg:'#ffffff', bg2:'#f8f9fa', text:'#1a1a2e', textLight:'#666', accent:'#667eea', accentHover:'#5a6fd6', cardBg:'#f8f9fa', border:'#e0e0e0', shadow:'0 10px 40px rgba(0,0,0,0.1)', gold:'#f5a623', gradient:'linear-gradient(135deg, #667eea, #764ba2)' },
