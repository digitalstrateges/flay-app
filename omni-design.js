/**
 * Flay Omni - Design System Premium
 * Composants UI unifies, animations, micro-interactions
 */

const OmniDesign = {
    // === ICONS SVG (remplace les emojis) ===
    icons: {
        ...
        checkCircle: `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M8 12l3 3 5-5"/></svg>`,
        close: `<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M18 6L6 18M6 6l12 12"/></svg>`,
        star: `<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26"/></svg>`,
        starFilled: `<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" stroke-width="2"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26"/></svg>`,
        arrowRight: `<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14M12 5l7 7-7 7"/></svg>`,
        arrowLeft: `<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M19 12H5M12 19l-7-7 7-7"/></svg>`,
        ...
        qr: `<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="2" width="8" height="8" rx="1"/><rect x="14" y="2" width="8" height="8" rx="1"/><rect x="2" y="14" width="8" height="8" rx="1"/><rect x="14" y="14" width="4" height="4" rx="1"/><line x1="22" y1="14" x2="22" y2="14.01"/><line x1="22" y1="18" x2="22" y2="18.01"/><line x1="18" y1="22" x2="18" y2="22.01"/><line x1="14" y1="22" x2="14" y2="22.01"/></svg>`,
        ...
        moonFill: `<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" stroke-width="2"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"/></svg>`,
        sunFill: `<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="5"/><line x1="12" y1="1" x2="12" y2="3"/><line x1="12" y1="21" x2="12" y2="23"/><line x1="4.22" y1="4.22" x2="5.64" y2="5.64"/><line x1="18.36" y1="18.36" x2="19.78" y2="19.78"/><line x1="1" y1="12" x2="3" y2="12"/><line x1="21" y1="12" x2="23" y2="12"/><line x1="4.22" y1="19.78" x2="5.64" y2="18.36"/><line x1="18.36" y1="5.64" x2="19.78" y2="4.22"/></svg>`
    },
    ...
    // === Themes avec gradients raffines ===
    themes: {
        dark: {
            bg: '#0a0a1a', bg2: '#111128', surface: '#15152a', surfaceHover: '#1c1c3a',
            border: '#252545', borderHover: '#353565',
            text: '#ffffff', textSecondary: '#a0a0c0', textMuted: '#6b6b8a',
            accent: '#667eea', accentHover: '#5a6fd6', accentLight: 'rgba(102,126,234,0.12)',
            success: '#4ade80', successLight: 'rgba(74,222,128,0.12)',
            warning: '#fbbf24', warningLight: 'rgba(251,191,36,0.12)',
            danger: '#ef4444', dangerLight: 'rgba(239,68,68,0.12)',
            gold: '#ffd700', goldLight: 'rgba(255,215,0,0.12)',
            gradient: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)',
            gradientHover: 'linear-gradient(135deg, #5a6fd6 0%, #6a4292 100%)',
            gradientSubtle: 'linear-gradient(135deg, rgba(102,126,234,0.15) 0%, rgba(118,75,162,0.15) 100%)',
            glass: 'rgba(21,21,42,0.8)', glassBorder: 'rgba(255,255,255,0.08)'
        },
        light: {
            bg: '#f8fafc', bg2: '#f1f5f9', surface: '#ffffff', surfaceHover: '#f8fafc',
            border: '#e2e8f0', borderHover: '#cbd5e1',
            text: '#0f172a', textSecondary: '#64748b', textMuted: '#94a3b8',
            accent: '#667eea', accentHover: '#5a6fd6', accentLight: 'rgba(102,126,234,0.08)',
            success: '#22c55e', successLight: 'rgba(34,197,94,0.08)',
            warning: '#f59e0b', warningLight: 'rgba(245,158,11,0.08)',
            danger: '#ef4444', dangerLight: 'rgba(239,68,68,0.08)',
            gold: '#d97706', goldLight: 'rgba(217,119,6,0.08)',
            gradient: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)',
            gradientHover: 'linear-gradient(135deg, #5a6fd6 0%, #6a4292 100%)',
            gradientSubtle: 'linear-gradient(135deg, rgba(102,126,234,0.08) 0%, rgba(118,75,162,0.08) 100%)',
            glass: 'rgba(255,255,255,0.8)', glassBorder: 'rgba(0,0,0,0.06)'
        }
    },

    // === Genere le CSS d'un theme ===
    getThemeCSS(themeName) {
        const t = this.themes[themeName] || this.themes.dark;
        return `
            --bg: ${t.bg}; --bg2: ${t.bg2}; --surface: ${t.surface}; --surface-hover: ${t.surfaceHover};
            --border: ${t.border}; --border-hover: ${t.borderHover};
            --text: ${t.text}; --text-secondary: ${t.textSecondary}; --text-muted: ${t.textMuted};
            --accent: ${t.accent}; --accent-hover: ${t.accentHover}; --accent-light: ${t.accentLight};
            --success: ${t.success}; --success-light: ${t.successLight};
            --warning: ${t.warning}; --warning-light: ${t.warningLight};
            --danger: ${t.danger}; --danger-light: ${t.dangerLight};
            --gold: ${t.gold}; --gold-light: ${t.goldLight};
            --gradient: ${t.gradient}; --gradient-hover: ${t.gradientHover}; --gradient-subtle: ${t.gradientSubtle};
            --glass: ${t.glass}; --glass-border: ${t.glassBorder};
        `;
    }
};

module.exports = OmniDesign;
