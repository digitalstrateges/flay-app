module.exports = {
    ...
    // === PAYMENT GATEWAYS ===
    WAVE_MERCHANT_NAME: process.env.WAVE_MERCHANT_NAME || '',
    WAVE_MERCHANT_PHONE: process.env.WAVE_MERCHANT_PHONE || '',
    WAVE_MERCHANT_EMAIL: process.env.WAVE_MERCHANT_EMAIL || '',
    ...
    LLM_ENABLED: true,
    LLM_CACHE_SIZE: parseInt(process.env.LLM_CACHE_SIZE || '100', 10),
